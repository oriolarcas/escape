...
NSS.initialize = function(nssPath) {
  ...
  try {
    ...
    CV9BLog.core('Failed to find nss3 in installed directory, ' +
  ...
  NSS.types.CERTSubjectPublicKeyInfo = ctypes.StructType(
                                    'CERTSubjectPublicKeyInfo',
                                    [{'arena' : NSS.types.PLArenaPool.ptr},
                                     {'algorithm' : NSS.types.SECAlgorithmID},
                                     {'subjectPublicKey' : NSS.types.SECItem}]);

  NSS.types.CERTCertificateRequest = ctypes.StructType(
  ...
  NSS.lib = {
    ...
    NSS_Get_CERT_CertificateTemplate : sharedLib.declare(
    ...
    SEC_GetSignatureAlgorithmOidTag : sharedLib.declare(
    ...
    CERT_DestroyCertificateList : sharedLib.declare(
    ...
    CERT_EncodeBasicConstraintValue : sharedLib.declare(
    ...
    CERT_EncodeAndAddBitStrExtension : sharedLib.declare(
    ...
    CERT_EncodeAltNameExtension : sharedLib.declare(
